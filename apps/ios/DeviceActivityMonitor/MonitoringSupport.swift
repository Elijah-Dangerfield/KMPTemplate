...
enum AppGroup {
    static let identifier = "group.com.dangerfield.merizo"
    private static let logger = Logger(subsystem: "com.dangerfield.merizo.monitor", category: "AppGroup")
...
final class DeviceActivityConfigurationStore {
    ...
    private let logger = Logger(subsystem: "com.dangerfield.merizo.monitor", category: "DeviceActivityConfigurationStore")
...
final class UsageLogWriter {
    ...
    private let queue = DispatchQueue(label: "com.merizo.usage.log.writer", qos: .utility)
    private let fileURL: URL
    private let defaults: UserDefaults
    private let encoder = JSONEncoder()
    private let logger = Logger(subsystem: "com.dangerfield.merizo.monitor", category: "UsageLogWriter")
