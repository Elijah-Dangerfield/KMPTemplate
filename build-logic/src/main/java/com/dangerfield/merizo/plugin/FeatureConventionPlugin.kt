 ...
 * - Pure UI component libraries (use merizo.compose.multiplatform instead)
 * - Pure Kotlin libraries without UI (use merizo.kotlin.multiplatform instead)
...
class FeatureConventionPlugin : Plugin<Project> {
    override fun apply(target: Project) {
        with(target) {
            with(pluginManager) {
                apply("merizo.compose.multiplatform")
