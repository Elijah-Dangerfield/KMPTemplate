package com.dangerfield.goodtimes.libraries.goodtimes.impl.logging

import com.dangerfield.goodtimes.libraries.core.logging.LogContext
import com.dangerfield.goodtimes.libraries.core.logging.LogEntry
import com.dangerfield.goodtimes.libraries.core.logging.LogId
import com.dangerfield.goodtimes.libraries.core.logging.LogLevel
import com.dangerfield.goodtimes.libraries.core.logging.LogTree

/**
 * Forwards structured log entries to the existing Kermit logger so new callers using [com.dangerfield.goodtimes.libraries.core.logging.KLog]
