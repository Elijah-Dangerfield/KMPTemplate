...
import com.kmptemplate.libraries.core.shouldNotBeCaught
import com.kmptemplate.libraries.core.throwIfDebug
import com.kmptemplate.libraries.flowroutines.AppCoroutineScope
import com.kmptemplate.libraries.flowroutines.observeWithLifecycle
        ...
        processingJob = appScope.launch {
            ...
            navigationRequests
                ...
                .observeWithLifecycle(
                    lifecycle = lifecycle,
                    tag = "DelegatingRouter navigation queue",
                ) { command ->
                    command(controller)
                }
        }
