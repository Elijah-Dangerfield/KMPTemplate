...
import com.dangerfield.merizo.libraries.core.Platform
import com.dangerfield.merizo.libraries.core.buildType
import com.dangerfield.merizo.libraries.core.logging.KLog
import com.dangerfield.merizo.libraries.core.logging.LogLevel
import com.dangerfield.merizo.libraries.core.logging.Logger
import com.dangerfield.merizo.libraries.merizo.Telemetry
import com.dangerfield.merizo.libraries.merizo.impl.logging.KermitLogTree
import com.dangerfield.merizo.libraries.merizo.impl.logging.SentryLogTree
...
data class SentryRuntimeConfig(
    ...
    companion object {
        fun forApp(buildInfo: BuildInfo): SentryRuntimeConfig {
            ...
            val release = "merizoe@${buildInfo.versionName}+${buildInfo.buildNumber}"
