...
class BottomSheetState(
    ...
    companion object {
        ...
        fun Saver(confirmValueChange: (BottomSheetValue) -> Boolean, density: Density): Saver<com.dangerfield.libraries.ui.components.dialog.bottomsheet.BottomSheetState, *> =
            Saver(
