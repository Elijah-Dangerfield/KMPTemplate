    ...
    BasicTextField(
        ...
        decorationBox = { innerTextField ->
            OutlinedTextFieldDefaults.DecorationBox(
                ...
                colors = com.kmptemplate.libraries.ui.components.text.outlinedTextFieldColors,
                contentPadding = com.kmptemplate.libraries.ui.components.text.outlineTextFieldPadding,
                container = {
                    OutlinedTextFieldDefaults.ContainerBox(
                        ...
                        focusedBorderThickness = com.kmptemplate.libraries.ui.components.text.FocusedBorderThickness,
                        unfocusedBorderThickness = com.kmptemplate.libraries.ui.components.text.UnfocusedBorderThickness,
                    )
                },
            )
        }
...
private fun PreviewOutlinedTextField() {
    PreviewContent(modifier = Modifier.padding(24.dp)) {
        com.kmptemplate.libraries.ui.components.text.OutlinedTextField(
            value = "Hello World",
            onValueChange = { })
    }
}
