...
import com.kmptemplate.libraries.ui.components.icon.icons.App_shortcut
import com.kmptemplate.libraries.ui.components.icon.icons.HomeFilled
import com.kmptemplate.libraries.ui.components.icon.icons.TipJarIcon
...
enum class Icons(
    ...
    Home(
        default = com.kmptemplate.libraries.ui.components.icon.icons.Home,
        filled = HomeFilled,
        outlined = com.kmptemplate.libraries.ui.components.icon.icons.Home,
    ),
    ...
    SnowFlake(com.kmptemplate.libraries.ui.components.icon.icons.SnowFlake),
