...
import com.kmptemplate.libraries.ui.ANNOTATED_STRING_ON_CLICK_KEY
import com.kmptemplate.libraries.ui.ANNOTATED_STRING_URL_KEY
import com.kmptemplate.libraries.ui.ClickableTextDefaults
import com.kmptemplate.libraries.ui.ClickableTextSegment
import com.kmptemplate.libraries.ui.ClickableTextValue
import com.kmptemplate.libraries.ui.LinkAppearance
import com.kmptemplate.libraries.ui.PreviewContent
import com.kmptemplate.libraries.ui.buildClickableText
import com.kmptemplate.libraries.ui.detectAndAnnotateLinks
...
private fun ClickableTextCatalogPreview() {
    PreviewContent {
        Column(
            ...
            ClickableText(
                text = "Visit https://kmptemplate.app/support or https://status.kmptemplate.app for updates.",
                onClickUrl = {}
            )
            ...
            ClickableText(
                text = "Auto-linking disabled even though https://kmptemplate.app/docs is present.",
                autoLinkUrls = false
            )

            ClickableText(
                text = "Custom auto link style https://kmptemplate.app/pricing",
